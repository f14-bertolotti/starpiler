...
with open(configuration.draw.input_path, 'rb') as file:
    graph, _, visited, _ = pickle.load(file)
...
edge_color = [[s.r,s.g,s.b,s.a] if e0.tree in visited and e1.tree in visited and d["data"]["visited"]==False else ([u.r,u.g,u.b,u.a] if not d["data"]["visited"] else [v.r,v.g,v.b,v.a]) for e0,e1,d in graph.edges.data()]
