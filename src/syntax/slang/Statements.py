...
nodeclr_assign_arr = P(name="s_nodecl_assign_arr", rules=[R(identifier, T("["), expr, T("]"), T("="), expr, T(";"))])
assignement = P(name="s_assign", rules=[declare_assign, nodeclr_assign, nodeclr_assign_arr], mod="?")
