...
class Test(unittest.TestCase):
    ...
    def test_integer(self):
        tree = types(lang.parse("def int64 start() does return 1 + 12 - 1233 ;;"))
    ...
    def test_rational(self):
        tree = types(lang.parse("def int64 start() does return 1.0 + 12.12 - 1233.333 ;;"))
    ...
    def test_global_assignement(self):
        treeAndRes = [(types(lang.parse("def double x = 1233.333;")), Double()),
                      (types(lang.parse("def void f0(int64 x, int64 y) does return;; def (int64, int64 -> void)* f = &f0;")), Pointer(FType([Int64(), Int64()], Void()))),]
    ...
    def test_function_definition(self):
        treeAndRes = [(types(lang.parse("def double  f() does return 1.0 + 12.12 - 1233.333;;"))      , FType([], Double())),
                      (types(lang.parse("def void    f(int64 x, int64 y) does return;;"))             , FType([Int64(), Int64()], Void())),
                      (types(lang.parse("def double* f(int64 x, double y) does return 0 as int8*;;")) , FType([Int64(), Double()], Pointer(Double())))]
    ...
    def test_function_declaration(self):
        treeAndRes = [(types(lang.parse("def double f(int64, int64);"))        , FType ([Int64(), Int64()], Double())),
                      (types(lang.parse("def int8*  f(int8*, ...);"))          , FType ([Pointer(Int8())], Pointer(Int8()), vararg=True)),
                      (types(lang.parse("def void   f(int64, int64, int8*);")) , FType ([Int64(), Int64(), Pointer(Int8())], Void()))]
    ...
    def test_class_definition(self):
        ...
        treeAndRes = [(types(lang.parse("class X with def int64 x; def int64 y;;"))                  , restype0),
                      (types(addEndMethods(lang.parse("class X with def int64 x; def int64 y;;"))) , restype1),
                      (types(lang.parse("class X with def X* x;;"))                                  , restype2)]
        for tree, res in treeAndRes:
    ...
    def test_class_import(self):
        ...
        treeAndRes = [(types(lang.parse("from \"src/testing/spplang/programs/class.spp\" import X as Y;")), restype0)]
        for tree, res in treeAndRes:
