...
from src.transpilers.ssharp.spp import ffi, newof_natives, ifs, builtin, remove_mainmethod, futurepops_ssharp, fors, classAccesses, newofs, indexes,  whiles, news
...
class Imports(AppliedTransformer):
    ...
    def ssharplang_import(self, meta, nodes):
        ...
        if importpath not in Imports.path2cached:
            ...
            for delta in [builtin, remove_mainmethod, classes, ffi, fields, methods, arrays, fors, ifs, whiles, news, futurepops_ssharp, newof_natives, futurepops_ssharp, newofs, futurepops_ssharp, assignements, indexes, classAccesses, Imports().transform, identities]:
            ...
            import rich
            print("="*100)
            rich.print(SppPrettyPrinter().transform(parseTree))
