...
def transpile(parseTree):
    for delta in [builtin, news, futurepops_ssharp, newof_natives, futurepops_ssharp, newofs, futurepops_ssharp, ifs, fors, whiles, mainMethod, classes, fields, assignements, indexes, methods, arrays, classAccesses, imports, identities]: 
...
deltas = [builtin, news, futurepops_ssharp, newof_natives, futurepops_ssharp, newofs, futurepops_ssharp, ifs, fors, whiles, mainMethod, classes, fields, assignements, indexes, methods, arrays, classAccesses, imports, identities]
